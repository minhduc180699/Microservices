package com.saltlux.deepsignal.adapter.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.saltlux.deepsignal.adapter.IntegrationTest;
import com.saltlux.deepsignal.adapter.repository.timezone.DateTimeWrapper;
import com.saltlux.deepsignal.adapter.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ds_date_time_wrapper where id=%d", fieldName, id);
    }
