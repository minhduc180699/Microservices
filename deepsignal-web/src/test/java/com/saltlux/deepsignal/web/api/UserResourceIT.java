...
import com.saltlux.deepsignal.web.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void createUserWithExistingId() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(DEFAULT_ID.toString());
        managedUserVM.setLogin(DEFAULT_LOGIN);
        managedUserVM.setPassword(DEFAULT_PASSWORD);
        managedUserVM.setFirstName(DEFAULT_FIRSTNAME);
        managedUserVM.setLastName(DEFAULT_LASTNAME);
    ...
    void testUserEquals() throws Exception {
        ...
        User user1 = new User();
        user1.setId(DEFAULT_ID.toString());
        User user2 = new User();
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setId(DEFAULT_ID.toString());
    ...
    void testUserToUserDTO() {
        user.setId(DEFAULT_ID.toString());
        ...
        assertThat(userDTO.getActivated()).isEqualTo(1);
