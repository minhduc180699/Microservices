...
import static com.saltlux.deepsignal.web.api.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.saltlux.deepsignal.web.IntegrationTest;
...
import com.saltlux.deepsignal.web.service.dto.PasswordChangeDTO;
...
class AccountResourceIT {
    ...
    void testActivateAccount() throws Exception {
        ...
        assertThat(user.getActivated()).isEqualTo(1);
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        assertThat(updatedUser.getActivated()).isEqualTo(1);
