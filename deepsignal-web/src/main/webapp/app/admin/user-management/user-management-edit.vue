        ...
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              required
            />
            <div v-if="($v.userAccount.email.$anyDirty && $v.userAccount.email.$invalid) || isCheckEmail">
              <small
                class="form-text text-danger"
              ...
              <small class="form-text text-danger" v-if="isCheckEmail" v-text="$t('global.messages.validate.email.already-exist')">
                Your email is required.
              </small>
            </div>
          </div>
