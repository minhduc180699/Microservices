<template>
  <div id="wrap" @mouseup="mouseUp($event)">
        ...
        <div class="row row-20 align-items-center mb-3">
          <div class="col">
            <div class="resources-category">
              <a href="/myconnectome/learning-management/learning-doc" class="active"
                ><i class="icon-resources-doc"></i><span>Document</span></a
              >
              <!--              <a href="/myconnectome/learning-management/learning-tag"><i class="icon-resources-tag"></i><span>Search/Web</span></a>-->
              <a href="/myconnectome/learning-management/learning-web"><i class="icon-resources-web"></i><span>Search/Web</span></a>
              ...
              <div class="col-6" v-for="value in list[data - 1].fileInfoList" :key="value.id">
                <div class="resource box-shadow-none">
                  <div class="row row-20 align-items-center">
                    <div class="col-auto">
                      <!--                      render ảnh theo file-->
                      <!--                      <img src="content/images/icon-excel-lg.png" alt="" v-if="getImageAvatar(value.name) === 'png'">-->
                      <!--                      <img src="content/images/icon-ppt.png" alt="" v-if="getImageAvatar(value.name) === 'pdf'">-->

                      <img src="content/images/icon-excel-lg.png" alt="" />
                    </div>
                    <div class="col">
                      <div class="tit">
                        <a href="">{{ value.name }}</a>
                      </div>
                      <div class="info">내 파일 | {{ convertToSpace(value.size) }}</div>
                    </div>
                  </div>
    ...
    <b-modal id="deleteData" header-bg-variant="info" footer-bg-variant="white" centered @ok="DeleteOk">
...
<script lang="ts" src="./learningDoc.component.ts"></script>
