...
!(function (t, e) {
  ...
  function za(t, e) {
    ...
    return (
      r &&
        r.smoothChildTiming &&
        t._ts &&
        ((t._start = ca(r._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts))),
        ya(t),
        r._dirty || sa(r, t)),
      t
    );
  ...
  function Da(t, e, r, i) {
    return (
      Ut(t, e),
      t._initted
        ? !r && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== Ct.frame
    ...
    return (
      ...
      function (t, e, r) {
        ...
        if (!c) {
          ...
          for (
            c = y[d] = [], i = b ? Math.min(f, d) * w - 0.5 : g % f, n = b ? (d * x) / f - 0.5 : (g / f) | 0, l = X, u = h = 0;
            u < d;
            u++
          )
            (a = (u % f) - i),
          ...
          'random' === g && Wa(c),
            ...
            (c.min = l),
            (c.v = d =
              (parseFloat(_.amount) || parseFloat(_.each) * (d < f ? d - 1 : T ? ('y' === T ? d / f : f) : Math.max(f, d / f)) || 0) *
              ('edges' === g ? -1 : 1)),
            (c.b = d < 0 ? v - d : v),
    ...
    for (var r, i = t._first; i; )
      i instanceof qt
        ...
        : !i.vars.yoyoEase ||
          (i._yoyo && i._repeat) ||
          i._yoyo === e ||
          (i.timeline ? Gb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
        (i = i._next);
  }
  function Ib(t, e, r, i) {
    void 0 === r &&
  ...
  var Rt,
    ...
    Nt =
      ...
      (Rt.totalDuration = function totalDuration(t) {
        return arguments.length
          ? ((this._dirty = 0), Ia(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
      ...
      (Rt.time = function time(t, e) {
        return arguments.length
          ? this.totalTime(Math.min(this.totalDuration(), t + va(this)) % this._dur || (t ? this._dur : 0), e)
          : this._time;
      }),
              ...
              ((this._ps = t)
                ...
                : (Dt(),
                  ...
                  this.totalTime(
                    ...
                    1 === this.progress() && (this._tTime -= U) && Math.abs(this._zTime) !== U
                  ))),
            this)
          : this._ps;
      }),
    ...
    return (
          ...
          if (
            ...
            if (
              ...
              if (
                ((g = this._dur),
                (m = this._tDur),
                T && ((this._lock = 2), (_ = b ? g : -1e-4), this.render(_, !0), this.vars.repeatRefresh && !p && this.invalidate()),
                (this._lock = 0),
                !this._ts && !u)
              )
                return this;
          ...
          if (_ <= i && 0 <= t)
            ...
            for (var w = t < 0 ? t : i; n; ) {
              if (((a = n._prev), (n._act || w <= n._end) && n._ts && h !== n)) {
                if (n.parent !== this) return this.render(t, e, r);
                if (
                  (n.render(0 < n._ts ? (w - n._start) * n._ts : (n._dirty ? n.totalDuration() : n._tDur) + (w - n._start) * n._ts, e, r),
                  i !== this._time || (!this._ts && !u))
                ) {
      ...
      (e.getTweensOf = function getTweensOf(t, e) {
        for (var r, i = [], n = xt(t), a = this._first, s = q(e); a; )
          a instanceof Qt
            ? da(a._targets, n) &&
              (s ? (!Yt || (a._initted && a._ts)) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) &&
              i.push(a)
  ...
  var Yt,
    Xt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
      ...
      if (
        (o(i) &&
          ...
          '=' === i.charAt(1) &&
            ((!(l = parseFloat(d) + parseFloat(i.substr(2)) * ('-' === i.charAt(0) ? -1 : 1) + (Pa(d) || 0)) && 0 !== l) || (i = l))),
        d !== i)
      )
        return isNaN(d * i) || '' === i
          ? (f || e in t || N(e, i),
      ...
      if (
        ...
        if (((p = (l = D[0] ? _(D[0]).harness : 0) && g[l.prop]), (i = ma(g, ut)), C && C.render(-1, !0).kill(), y))
          ...
          if (C) A || (e._startAt = 0);
            ...
            (r && (b = !1),
            (a = ia({ overwrite: !1, data: 'isFromStart', lazy: b && t(T), immediateRender: b, stagger: 0, parent: z }, i)),
            p && (a[l.prop] = p),
    ...
    Qt = (function (S) {
      function Tween(e, r, i, n) {
        ...
        if (
          ((a._targets = A.length ? $(A) : O('GSAP target ' + e + ' not found. https://greensock.com', !Y.nullTargetWarn) || []),
          (a._ptLookup = []),
          (a._overwrite = T),
          w || b || v(m) || v(g))
        ) {
            ...
            !(function _renderZeroDurationTween(t, e, r, i) {
              ...
              if (
                ...
                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                  ...
                  (e >= t._tDur || e < 0) &&
                    t.ratio === u &&
                    (u && ra(t, 1), r || (Pt(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()));
  ...
  function ud(e) {
    ...
    return (
      ...
      !r || r.width || r.x || r.y ? r : { x: +td(e, ['x', 'cx', 'x1']) || 0, y: +td(e, ['y', 'cy', 'y1']) || 0, width: 0, height: 0 }
    );
  }
  function vd(t) {
  ...
  function Ld(t, e, r, i, n, a) {
    ...
    r
      ? l !== Ge &&
        (o = _ * v - m * g) &&
        ((u = w * (-m / o) + x * (_ / o) - (_ * b - m * y) / o), (w = w * (v / o) + x * (-g / o) + (g * b - v * y) / o), (x = u))
      : ((w = (s = ud(t)).x + (~T[0].indexOf('%') ? (w / 100) * s.width : w)),
        (x = s.y + (~(T[1] || T[0]).indexOf('%') ? (x / 100) * s.height : x))),
      i || (!1 !== i && h.smooth)
        ? ((y = w - f), (b = x - d), (h.xOffset = c + (y * _ + b * g) - y), (h.yOffset = p + (y * m + b * v) - b))
  ...
  var ue,
    ...
    $e = function _parseTransform(t, e) {
      ...
      return (
        ...
        90 < Math.abs(f) &&
          Math.abs(f) < 270 &&
          (F ? ((s *= -1), (f += u <= 0 ? 180 : -180), (u += u <= 0 ? 180 : -180)) : ((o *= -1), (f += f <= 0 ? 180 : -180))),
        (r.x =
          i -
          ...
          if ('autoRound' !== f && ((s = e[f]), !ft[f] || !Sb(f, e, r, i, t, n)))
            if (
              ...
              if (
                ...
                if (
                  (m ||
                    (((g = t._gsap).renderTransform && !e.parseTransform) || $e(t, e.parseTransform),
                  ...
                  if ('transformOrigin' === f) {
                    (s = Dd(s)),
                      g.svg
                        ? Ld(t, s, 0, v, 0, this)
                        : ((c = parseFloat(s.split(' ')[2]) || 0) !== g.zOrigin && xd(this, g, 'zOrigin', g.zOrigin, c),
