...
!(function (t, e) {
  ...
  var B = {
      ...
      toPadding: function (t) {
        var e, n, i, a;
        return (
          M.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (a = +t.left || 0)) : (e = n = i = a = +t || 0),
  ...
  z._set('global', {
    elements: { arc: { backgroundColor: z.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' } },
  });
  var ot = X.extend({
      _type: 'arc',
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view),
              ...
              n.skip || ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : V.canvas.lineTo(r, e._view, n), (d = t));
    ...
    var i,
      ...
      l = (function (t) {
        var e = t.borderSkipped,
          n = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = vt(e, 'left', 'right')) : t.base < t.y && (e = vt(e, 'bottom', 'top')), (n[e] = !0), n)
          : n;
      })(t);
    return (
  ...
  function ue(t, e, n) {
    ...
    if (((i = e.outerWidth - le(o, t, 'left', 'right')), (a = e.outerHeight - le(o, t, 'top', 'bottom')), i !== t.w || a !== t.h))
      ...
      return n && n.canvas === t
        ? (this._ensureLoaded(t),
          (function (t, e) {
            ...
            if (
              ((t[me] = { initial: { height: i, width: a, style: { display: n.display, height: n.height, width: n.width } } }),
  ...
  var je = X.extend({
      ...
      drawBody: function (t, e, n) {
        ...
        for (
          ...
          for (
            i = g[s], a = e.labelTextColors[s], r = e.labelColors[s], n.fillStyle = a, V.each(i.before, x), l = 0, d = (o = i.lines).length;
            l < d;
            ++l
          ) {
            if (p) {
  ...
  var bn = X.extend({
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e = hn(t.ctx, pn(t.options.ticks), t.getTicks(), t.longestTextCache)), (t.longestLabelWidth = e.widest.width)),
        e
      );
    },
      ...
      getPixelForValue: function (t, e, n) {
        ...
        return (
          ...
          (void 0 !== i || (void 0 !== t && isNaN(e))) &&
            ((a = o._getLabels()), (t = V.valueOrDefault(i, t)), (e = -1 !== (r = a.indexOf(t)) ? r : e), isNaN(e) && (e = t)),
  ...
  var Rn = xn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = On(e.min, t.min)),
          ...
          null === t.minNotZero &&
            (t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(Fn(t.max)))) : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            0 === r
              ? ((n = Math.floor(Fn(e.minNotZero))), (i = Math.floor(e.minNotZero / Math.pow(10, n))), a.push(r), (r = i * Math.pow(10, n)))
  ...
  var di = xn.extend({
      ...
      getPixelForValue: function (t, e, n) {
        var i = null;
        if ((void 0 !== e && void 0 !== n && (i = this._timestamps.datasets[n][e]), null === i && (i = si(this, t)), null !== i))
  ...
  an._date.override(
    'function' == typeof t
      ? {
          ...
          parse: function (e, n) {
            return (
              'string' == typeof e && 'string' == typeof n ? (e = t(e, n)) : e instanceof t || (e = t(e)), e.isValid() ? e.valueOf() : null
            );
          },
          format: function (e, n) {
            return t(e).format(n);
      ...
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            ...
            o && s && r.length && (V.canvas.clipArea(u, t.chartArea), _i(u, r, o, a, s, i._loop), V.canvas.unclipArea(u)));
      },
    },
    ...
    draw: function () {
      ...
      if (e.display) {
        ...
        var m = Ci(n, p),
          ...
          x = t.isHorizontal();
        (d = x ? { x: t.left + b(l, u[0]), y: t.top + n.padding, line: 0 } : { x: t.left + n.padding, y: t.top + b(o, s[0]), line: 0 }),
