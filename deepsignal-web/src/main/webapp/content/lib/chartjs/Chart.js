...
*/
  ...
  var exports$1 = {
    ...
    _isPointInArea: function (point, area) {
      ...
      return (
        point.x > area.left - epsilon && point.x < area.right + epsilon && point.y > area.top - epsilon && point.y < area.bottom + epsilon
      );
    },
  ...
  var exports$4 = core_element.extend({
    ...
    drawBody: function (pt, vm, ctx) {
      ...
      xLinePadding =
        drawColorBoxes && bodyAlignForCalculation !== 'right' ? (bodyAlign === 'center' ? bodyFontSize / 2 + 1 : bodyFontSize + 2) : 0;
  ...
  var Scale = core_element.extend({
    ...
    _drawTitle: function () {
      ...
      if (me.isHorizontal()) {
        ...
        scaleLabelY =
          position === 'bottom' ? me.bottom - halfLineHeight - scaleLabelPadding.bottom : me.top + halfLineHeight + scaleLabelPadding.top;
      } else {
  ...
  function computeCircularBoundary(source) {
    ...
    for (i = 0; i < length; ++i) {
      point =
        fill === 'start' || fill === 'end' ? scale.getPointPositionForValue(i, fill === 'start' ? start : end) : scale.getBasePosition(i);
