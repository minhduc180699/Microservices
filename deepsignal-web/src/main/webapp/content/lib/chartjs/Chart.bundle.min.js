...
!(function (t, e) {
  ...
  (_.prototype = {
    ...
    mix: function (t, e) {
      var n = t,
        ...
        s = 1 - o;
      return this.rgb(o * this.red() + s * n.red(), o * this.green() + s * n.green(), o * this.blue() + s * n.blue()).alpha(
        this.alpha() * i + n.alpha() * (1 - i)
      );
    },
    toJSON: function () {
      return this.rgb();
  ...
  W._set('global', {
    elements: { arc: { backgroundColor: W.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' } },
  });
  var st = $.extend({
      _type: 'arc',
      ...
      inRange: function (t, e) {
        var n = this._view;
        if (n) {
          for (var i = H.getAngleFromPoint(n, { x: t, y: e }), a = i.angle, r = i.distance, o = n.startAngle, s = n.endAngle; s < o; )
            s += at;
          for (; a > s; ) a -= at;
          for (; a < o; ) a += at;
          var l = a >= o && a <= s,
    ...
    var i,
      ...
      l = (function (t) {
        var e = t.borderSkipped,
          n = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = bt(e, 'left', 'right')) : t.base < t.y && (e = bt(e, 'bottom', 'top')), (n[e] = !0), n)
          : n;
      })(t);
    return (
  ...
  var Ot = it.extend({
      ...
      _getStacks: function (t) {
        ...
        for (
          e = 0;
          e < o &&
          ((n = a[e]), (!1 === r || -1 === s.indexOf(n.stack) || (void 0 === r && void 0 === n.stack)) && s.push(n.stack), n.index !== t);
          ++e
        );
        return s;
      },
      ...
      calculateBarValuePixels: function (t, e, n) {
        ...
        if (v || (void 0 === v && void 0 !== b))
          for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
            a.stack === b &&
              ((r = void 0 === (u = h._parseValue(f[a.index].data[e])).start ? u.end : u.min >= 0 && u.max >= 0 ? u.max : u.min),
    ...
    legendCallback: function (t) {
      ...
      if ((a.setAttribute('class', t.id + '-legend'), o.length))
        for (e = 0, n = o[0].data.length; e < n; ++e)
          ((i = a.appendChild(document.createElement('li'))).appendChild(document.createElement('span')).style.backgroundColor =
            o[0].backgroundColor[e]),
  ...
  var Yt = it.extend({
    ...
    updateElement: function (t, e, n) {
      ...
      var v = t._model;
      (n && s.animateRotate) ||
        ((v.startAngle = 0 === e ? o.rotation : i.getMeta().data[e - 1]._model.endAngle), (v.endAngle = v.startAngle + v.circumference)),
        t.pivot();
    },
      ...
      return n && n.canvas === t
        ? (this._ensureLoaded(t),
          (function (t, e) {
            ...
            if (
              ((t[ve] = { initial: { height: i, width: a, style: { display: n.display, height: n.height, width: n.width } } }),
  ...
  var je = $.extend({
      ...
      drawBody: function (t, e, n) {
        ...
        for (
          ...
          for (
            i = g[s], a = e.labelTextColors[s], r = e.labelColors[s], n.fillStyle = a, H.each(i.before, y), l = 0, d = (o = i.lines).length;
            l < d;
            ++l
          ) {
            if (m) {
      ...
      handleEvent: function (t) {
        ...
        return (
          ...
          (e = !H.arrayEquals(n._active, n._lastActive)) &&
            ((n._lastActive = n._active), (i.enabled || i.custom) && ((n._eventPosition = { x: t.x, y: t.y }), n.update(!0), n.pivot())),
          e
        );
      },
    }),
  ...
  H.extend(tn.prototype, {
    ...
    eventHandler: function (t) {
      ...
      if (!1 !== Le.notify(e, 'beforeEvent', [t])) {
        ...
        return (
          a ? e.render(a) : i && !e.animating && (e.stop(), e.render({ duration: e.options.hover.animationDuration, lazy: !0 })),
          (e._bufferedRender = !1),
  ...
  function hn(t, e, n) {
    ...
    if (
      !(
        n &&
        ((i = 1 === a ? Math.max(o - s, l - o) : 0 === e ? (t.getPixelForTick(1) - o) / 2 : (o - t.getPixelForTick(r - 1)) / 2),
  ...
  var yn = $.extend({
      ...
      !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
        ...
        : ((e = (t = s._getLabelSizes()).widest.width),
          ...
          e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
            ...
            (o = Math.sqrt(e * e + n * n)),
            (f = H.toDegrees(
              Math.min(Math.asin(Math.min((t.highest.height + 6) / a, 1)), Math.asin(Math.min(r / o, 1)) - Math.asin(n / o))
            )),
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e = cn(t.ctx, pn(t.options.ticks), t.getTicks(), t.longestTextCache)), (t.longestLabelWidth = e.widest.width)),
        e
      );
    },
    _parseValue: function (t) {
      ...
      return (
        sn(t)
          ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n)))
      ...
      getPixelForValue: function (t, e, n) {
        ...
        return (
          ...
          (void 0 !== i || (void 0 !== t && isNaN(e))) &&
            ((a = o._getLabels()), (t = H.valueOrDefault(i, t)), (e = -1 !== (r = a.indexOf(t)) ? r : e), isNaN(e) && (e = t)),
  ...
  var Dn = xn.extend({
      ...
      getTickLimit: function () {
        var t,
          ...
          i = e.maxTicksLimit;
        return (
          n ? (t = Math.ceil(this.max / n) - Math.floor(this.min / n) + 1) : ((t = this._computeTickLimit()), (i = i || 11)),
          i && (t = Math.min(i, t)),
          t
        );
      },
  ...
  var Nn = xn.extend({
          ...
          for (t = 0; t < u.length; t++) {
            ...
            if (l.isDatasetVisible(t) && h(e))
              for (void 0 === f[g] && (f[g] = []), a = 0, r = (i = u[t].data).length; a < r; a++) {
                var m = f[g];
                (n = o._parseValue(i[a])),
                  isNaN(n.min) || isNaN(n.max) || e.data[a].hidden || n.min < 0 || n.max < 0 || ((m[a] = m[a] || 0), (m[a] += n.max));
              }
          }
          H.each(f, function (t) {
            if (t.length > 0) {
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Rn(e.min, t.min)),
          ...
          null === t.minNotZero &&
            (t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(In(t.max)))) : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            0 === r
              ? ((n = Math.floor(In(e.minNotZero))), (i = Math.floor(e.minNotZero / Math.pow(10, n))), a.push(r), (r = i * Math.pow(10, n)))
        ...
        if (
                ...
                (function (t, e, n, i) {
                  ...
                  if ((o || s) && l && u) {
                    if (
                      ...
                      (r.strokeStyle = l),
                      (r.lineWidth = u),
                      r.setLineDash && (r.setLineDash(e.borderDash || []), (r.lineDashOffset = e.borderDashOffset || 0)),
                      r.beginPath(),
                      o)
                    )
          ...
          for (
            a.save(),
              ...
              a.strokeStyle = u,
              a.setLineDash &&
                (a.setLineDash(En([s.borderDash, o.borderDash, []])), (a.lineDashOffset = En([s.borderDashOffset, o.borderDashOffset, 0]))),
    ...
    gi = e(function (e, n) {
      e.exports = (function () {
        ...
        function Gt(t, e, n, i, a) {
          ...
          return (
            s <= 0 ? (o = Dt((r = t - 1)) + s) : s > Dt(t) ? ((r = t + 1), (o = s - Dt(t))) : ((r = t), (o = s)), { year: r, dayOfYear: o }
          );
        }
        function qt(t, e, n) {
          var i,
        ...
        function ge(t, e) {
          ...
          return (
            t &&
              ((n = s(e) ? pe(t) : me(t, e))
                ? (se = n)
                : 'undefined' != typeof console && console.warn && console.warn('Locale ' + t + ' not found. Did you forget to load it?')),
            se._abbr
          );
        }
        function me(t, e) {
            ...
            if (((e.abbr = t), null != de[t]))
              ...
              if (null != de[e.parentLocale]) i = de[e.parentLocale]._config;
                ...
                if (null == (n = fe(e.parentLocale)))
                  return he[e.parentLocale] || (he[e.parentLocale] = []), he[e.parentLocale].push({ name: t, config: e }), null;
                i = n._config;
              }
            return (
              (de[t] = new F(A(i, e))),
                          ...
                          s(e)
                            ...
                            ? (function (t) {
                                ...
                                null === e
                                  ? (De(t),
                                    !1 === t._isValid &&
                                      (delete t._isValid, Oe(t), !1 === t._isValid && (delete t._isValid, a.createFromInputFallback(t))))
                                  : (t._d = new Date(+e[1]));
                              })(t)
                            : r(e)
        ...
        function Xe(t, e) {
          ...
          return (
            Ee(t)
              ...
              : (d = Ze.exec(t))
              ? ((n = '-' === d[1] ? -1 : 1),
                (u = { y: 0, d: k(d[yt]) * n, h: k(d[xt]) * n, m: k(d[_t]) * n, s: k(d[wt]) * n, ms: k(Ve(1e3 * d[kt])) * n }))
              : (d = $e.exec(t))
              ? ((n = '-' === d[1] ? -1 : 1),
                (u = { y: Ke(d[2], n), M: Ke(d[3], n), w: Ke(d[4], n), d: Ke(d[5], n), h: Ke(d[6], n), m: Ke(d[7], n), s: Ke(d[8], n) }))
              : null == u
              ? (u = {})
              : 'object' == typeof u &&
                ('from' in u || 'to' in u) &&
                ...
                (a =
                  r.isValid() && o.isValid()
                    ? ((o = Ue(o, r)),
                      r.isBefore(o) ? (s = Je(r, o)) : (((s = Je(o, r)).milliseconds = -s.milliseconds), (s.months = -s.months)),
                      s)
        ...
        (Mn.add = en),
          ...
          (Mn.isBefore = function (t, e) {
            ...
            return (
              !(!this.isValid() || !n.isValid()) &&
              ('millisecond' === (e = R(e) || 'millisecond') ? this.valueOf() < n.valueOf() : this.clone().endOf(e).valueOf() < n.valueOf())
            );
          }),
  ...
  function bi(t) {
    return (t.el._scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          if (!l) return null;
          for (
            e = s.ticks.reverse ? o.max : o.min, n = s.ticks.reverse ? o.min : o.max, i = o.getPointPositionForValue(0, e), a = 0;
            a < l;
            ++a
          )
    ...
    draw: function () {
      ...
      if (e.display) {
        ...
        var p = Pi(n, m),
          ...
          y = t.isHorizontal();
        (d = y ? { x: t.left + b(l, u[0]), y: t.top + n.padding, line: 0 } : { x: t.left + n.padding, y: t.top + b(o, s[0]), line: 0 }),
    ...
    handleEvent: function (t) {
      ...
      (e = n._getLegendItemAt(t.x, t.y)),
        'click' === a
          ...
          : (i.onLeave && e !== n._hoveredItem && (n._hoveredItem && i.onLeave.call(n, t.native, n._hoveredItem), (n._hoveredItem = e)),
