      ...
      modifiers: {
              ...
              d = {
                ...
                secondary: function (t) {
                  var n = 'right' === t ? 'left' : 'top',
                    i = f[n];
                  return (
                    f[t] > l[t] && !e.escapeWithReference && (i = Math.min(f[n], l[t] - ('right' === t ? f.width : f.height))), dt({}, n, i)
                  );
                },
              };
            return (
        ...
        inner: {
          ...
          fn: function (t) {
            ...
            return (
              (o[a ? 'left' : 'top'] = r[n] - (s ? o[a ? 'width' : 'height'] : 0)), (t.placement = Ct(e)), (t.offsets.popper = ht(o)), t
            );
          },
        },
        hide: {
