      ...
      function i(t, e, i) {
        ...
        return null == t
          ? i || !e.def
            ? null
            : e.def
          : ((t = s.floor ? ~~t : parseFloat(t)), isNaN(t) ? e.def : s.mod ? (t + s.mod) % s.mod : 0 > t ? 0 : t > s.max ? s.max : t);
      }
      function s(i) {
        var s = l(),
          n = (s._rgba = []);
            ...
            return (
              ...
              f(o.props, function (t, n) {
                ...
                null !== l &&
                  (null === a
                    ? (h[o] = l)
                    : (c.mod && (l - a > c.mod / 2 ? (a += c.mod) : a - l > c.mod / 2 && (a -= c.mod)), (h[o] = i((l - a) * e + a, n))));
              }),
              this[n](h)
            );
          },
      ...
      for (
        ...
        for (x = '', this.maxRows = 4, C = 0; U[1] > C; C++) {
          ...
          for (
            ...
            for (
              T += '<tr>', W = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, 'calculateWeek')(A) + '</td>' : '', w = 0;
              7 > w;
              w++
            )
          ...
          Z++,
            Z > 11 && ((Z = 0), te++),
            (T +=
              '</tbody></table>' + (X ? '</div>' + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '') : '')),
            (x += T);
        }
        y += x;
      }
  ...
  var v = (t.ui.intersect = (function () {
    ...
    return function (e, i, s, n) {
      ...
      switch (s) {
        ...
        case 'touch':
          return (
            ((a >= c && d >= a) || (h >= c && d >= h) || (c > a && h > d)) && ((o >= l && u >= o) || (r >= l && u >= r) || (l > o && r > u))
          );
        default:
          return !1;
      }
    ...
    t.widget('ui.selectmenu', [
      t.ui.formResetMixin,
      {
        ...
        _setSelection: function () {
          var t;
          this.range &&
            (window.getSelection ? ((t = window.getSelection()), t.removeAllRanges(), t.addRange(this.range)) : this.range.select(),
            this.button.focus());
        },
        _documentClick: {
          mousedown: function (e) {
        ...
        _resizeButton: function () {
          ...
          return t === !1
            ...
            : (null === t && ((t = this.element.show().outerWidth()), this.element.hide()), this.button.outerWidth(t), void 0);
        },
        _resizeMenu: function () {
