...
import com.saltlux.deepsignal.web.exception.UsernameAlreadyUsedException;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.saltlux.deepsignal.web.exception.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.saltlux.deepsignal.web.exception.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleMaxSizeException(MaxUploadSizeExceededException ex, NativeWebRequest request) {
        Problem problem = Problem
            .builder()
            .withStatus(Status.EXPECTATION_FAILED)
            .with(MESSAGE_KEY, ErrorConstants.ERR_FILE_TOO_LARGE)
            .build();
        return create(ex, problem, request);
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.saltlux.deepsignal");
    }
}
