...
public class WebsocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry config) {
        ...
        //            .setRelayHost(applicationProperties.getRabbitConfig().getUrl())
        //            .setRelayPort(applicationProperties.getRabbitConfig().getPort())
        //            .setClientLogin(applicationProperties.getRabbitConfig().getUsername())
        //            .setClientPasscode(applicationProperties.getRabbitConfig().getPassword());
