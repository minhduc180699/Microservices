...
This application was used Spring Boot + VueJS 2.6.14
...
The PWA (Progressive Web App) support, and it's turned off by default. One of the main components of a PWA is a service worker.
...
To build the final jar and optimize the DeepSignal application for production, run:
...
Finally, the best practice to build this source code:
