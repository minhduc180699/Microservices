...
//    private String favicon;
    ...
    public FeedDataModel(FeedModel feedModel, DocContentModel docContentModel) {
...
//        this.favicon = feedModel.getFavicon();
        ...
        this.web_source_category = docContentModel.getWeb_source_category();
        this.category_url = docContentModel.getCategory_url();
        this.description = docContentModel.getDescription();
        this.source_uri = docContentModel.getUrl();
        this.subdomain_url = docContentModel.getSubdomain_url();
        ...
        this.domain_url = docContentModel.getDomain_url();
        this.project_id = docContentModel.getProject_id();
        this.web_source_id = docContentModel.getWeb_source_id();
        ...
        this.comment_id = docContentModel.getComment_id();
        this.subcategory_url = docContentModel.getSubcategory_url();
        this.collected_at = docContentModel.getCollected_at();
        this.tags = docContentModel.getTags();
        this.content_search = docContentModel.getContent_search();
        this.service_type = docContentModel.getService_type();
        this.origin_date = docContentModel.getOrigin_date();
        this.reply_id = docContentModel.getReply_id();
