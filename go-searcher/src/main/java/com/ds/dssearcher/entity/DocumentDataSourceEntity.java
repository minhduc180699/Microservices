...
public class DocumentDataSourceEntity {
    private String datasource_id;
    private List<DataSourceEntity> data;
    ...
    public static class DataSourceEntity{
        ...
        public DataSourceEntity covertObjectToDoc(SearchHit hit){
            try{
                if(hit.getId() == null ) return null;
                DataSourceEntity doc = new DataSourceEntity();
